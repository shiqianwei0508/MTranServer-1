...
// Resolve font paths relative to this module so they work both in source mode
// and inside a compiled Bun single-file executable (mirrors engine.ts/detector.ts).
const currentDir = path.dirname(fileURLToPath(import.meta.url));
const resolveFontPath = (p: string): string => path.resolve(currentDir, p);
...
export const OCR_FONT_ASSETS: FontAsset[] = [
  {
    path: resolveFontPath(latin),
    unicodeRange: 'U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD',
  },
  {
    path: resolveFontPath(latinExt),
  ...
  { path: resolveFontPath(cjk112), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF' },
  { path: resolveFontPath(cjk113), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF' },
  { path: resolveFontPath(cjk114), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF' },
  { path: resolveFontPath(cjk115), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF' },
  { path: resolveFontPath(cjk116), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF' },
  { path: resolveFontPath(cjk117), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF' },
  { path: resolveFontPath(cjk118), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF' },
  { path: resolveFontPath(cjk119), unicodeRange: 'U+23,U+3D,U+4E00-9FFF,U+FF00-FFEF,U+3000-30FF' },
];
